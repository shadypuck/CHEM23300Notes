...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Solution: Polymerase chain reaction uses DNA polymerase, dNTPs, \ce{Mg^2+}, and some other things to make many many copies of just the 150 bps you're interested in.
    ...
    \begin{itemize}
        ...
        \item Label the $5'$ end of each sequence with \ce{{}^32P}. This will allow for visualizing the strands at the conclusion of the procedure using autoradiography and X-ray film.
