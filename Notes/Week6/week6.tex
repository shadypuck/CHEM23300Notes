...
\begin{itemize}
    \item \marginnote{11/3:}Today: Co-translational protein transport.
    ...
    \begin{figure}[h!]
        ...
        \caption{Post-translational protein translocation: Get pathway.}
        \label{fig:GetPathway}
    \end{figure}
    \begin{itemize}
        \item No SRP needed here.
        \item Instead, we have a Get pathway.
        \item \textbf{Snare proteins} (Nobel Prize 2013), which are very important in vesicle fusion and fision, decide how organelles come together.
        \item Before the Get pathway was discovered, people hypothesized that proteins ram themselves into the ER membrane, but there were many holes in this theory (e.g., why not ram into the plasma membrane?).
        \item The Get pathway is formed by 3 proteins: Get1, Get2, and Get3.
        \item Get1, Get2 only recognize Get3.
        \item Get3 is the key: It gets the C-terminus signal peptide, but only after it has been bound to a pre-targeting complex, inducing a conformational change that allows the pre-targeting complex to bind to specifically the ATP-bound form of Get3.
        \item Get3 is an ATPase, meaning that it hydrolyzes ATP.
        \item The pre-targeting complex binds the signal peptide sequence to Get3 ATPase; the mechanism is not well understood.
        \item Once this has happened, Get3 is competent to deliver the sequence to Get1-Get2, which is located in the ER membrane and functions as a translocator.
        \item In order to shove the sequence into Get1-Get2, we need energy; this energy comes from the hydrolysis of ATP to ADP + Pi.
        \item At this point, Get3 is ready to bind another ATP and restart the cycle.
        \item Contrast this with the GTPase cycle. Think about how an ATPase differs from a GTPase.
    \end{itemize}
    \item Glycosylation (overview).
    \begin{itemize}
        \item Many proteins need to be glycosylated (this will be the subject of next class).
        \item Additionally, many proteins are anchored to the ER membrane not by a transmembrane region but by a lipid. How is this related??
